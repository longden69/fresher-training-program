            ...
            <div class="span12">
                ...
                <div class="block-fluid table-sorting">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable_2">
                        ...
                        <tbody>
                        <?php
                        foreach ($data['listUser'] as $key1 =>$val1){
                        ?>
                            <tr>
                                <td><input type="checkbox" name="checkbox"/></td>
                                <td><?=$val1['user_id']?></td>
                                <td><?=$val1['username']?></td>
                                <td><span class="text-success"><?=$val1['status']?></span></td>
                                <td><?=$val1['user_time_created']?></td>
                                <td><?=$val1['user_time_updated']?></td>
                                <td><a href="index.php?controller=UserController&action=editUser&id=<?=$val1['user_id']?>" class="btn btn-info">Edit</a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
